      ...
      <table class="table table-bordered">
        <thead>
          <tr>
            ...
            <th>Group Name</th>
            <th class="text-center" style="width: 20%;">Level Group</th>
            <th class="text-center" style="width: 15%;">Status</th>
            <th class="text-center" style="width: 100px;">Accions</th>
          </tr>
        </thead>
        <tbody>
        <?php foreach($all_groups as $a_group): ?>
          <tr>
           ...
           <?php if($a_group['group_status'] === '1'): ?>
            <span class="label label-success"><?php echo "Enable"; ?></span>
          <?php else: ?>
            <span class="label label-danger"><?php echo "Disable"; ?></span>
          <?php endif;?>
           </td>
           <td class="text-center">
             <div class="btn-group">
