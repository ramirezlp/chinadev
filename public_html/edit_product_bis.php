...
$all_units = find_all1('units');
$all_vendors = find_all1('vendors');
$all_clients = find_all1('clients');
$all_packagings = find_all1('packaging');
$all_catsub = find_all('productscatsub');
$all_prices = find_all1('price_type');
if(!$product){
...
<div class="row">
  ...
  <div class="row">
    <div class="col-md-9">
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <div class="panel-body">
            <div id="tabProductBis">
            <ul>
            
            <li id="tab1"><a href="#ProductInfo">Product Info</a></li>
            <li><a href="#CustomerSettings">Customer Settings</a></li>
            
        </ul>
         <div class="col-md-12">
          <form id="editproduct" method="post" class="clearfix" enctype="multipart/form-data">
        ...
        <div id="ProductInfo">
            ...
            <div class="col-md-4">
              ...
              <label for="qty">Descriptions</label>
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-title-en" placeholder="English" value="<?php echo remove_junk($product['desc_english']);?>" autocomplete="off">
               </div>
               <div class="input-group">
                  <span class="input-group-addon">
                   <i class="glyphicon glyphicon-th-large"></i>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control" name="product-price" step="any" placeholder="Insert Price" value="<?php echo remove_junk($product['price']);?>" autocomplete="off">    
                </div>
              </div>
            </div>
            <div class="col-md-4">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
             ...
             <input type="number" class="form-control" name="product-ean13" placeholder="Insert Codebar EAN13" value="<?php echo remove_junk($product['ean13']);?>" autocomplete="off">
           </div>
          </div>
        </div>
          <div class="col-md-4">
        <div class="form-group">
          ...
          <label for="qty">DUN14</label>                   
            <input type="number" class="form-control" name="product-dun14" placeholder="Insert Codebar DUN14" value="<?php echo remove_junk($product['dun14']);?>" autocomplete="off">
          </div>
        </div>
      </div>
    </div>
       ...
       <div class="form-group">
        ...
        <div class="input-group">
         <input type="text" class="form-control" name="product-cbm" placeholder="Insert CBM" value="<?php echo remove_junk($product['cbm']);?>" autocomplete="off">
      ...
      <div class="input-group">
       <input type="text" class="form-control" name="product-size" placeholder="Insert Product size" value="<?php echo remove_junk($product['size']);?>" autocomplete="off">
     </div>
   </div>
    </div>
     <div class="col-md-3">
    ...
    <div class="input-group">
     <input type="text" class="form-control" name="product-material" placeholder="Insert Material" value="<?php echo remove_junk($product['material']);?>" autocomplete="off">
     </div>
     </div>
    </div>
    <div class="col-md-3">
        ...
        <div class="input-group">
         <input type="number" step="any" class="form-control" name="product-weight" placeholder="Insert Product Weight" value="<?php echo remove_junk($product['product_weight']);?>" autocomplete="off">
    ...
    <div class="input-group">
     <input type="text" class="form-control" name="product-color" placeholder="Insert Color" value="<?php echo remove_junk($product['color']);?>" autocomplete="off">
      </div>
    </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="input-group">
       <input type="text" class="form-control" name="product-uxb" placeholder="Insert Uxb" value="<?php echo remove_junk($product['uxb']);?>" autocomplete="off">                  
     </div>
   </div>
 </div>
 <div class="col-md-3">
  <div class="form-group">
    ...
    <div class="input-group">
     <input type="text" class="form-control" name="product-inner" placeholder="Insert Inner" value="<?php echo remove_junk($product['inners']);?>" autocomplete="off">
   </div>
 </div>
</div>
<div class="col-md-3">
  ...
  <div class="col-md-3">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
         <input type="number" step="any" class="form-control" name="product-netweight" placeholder="Insert CTN Net Weight" value="<?php echo remove_junk($product['netweight']);?>" autocomplete="off">
        ...
        <div class="input-group">
         <input type="number" step="any" class="form-control" name="product-grossweight" placeholder="Insert CTN Gross Weight" value="<?php echo remove_junk($product['grossweight']);?>" autocomplete="off">
         <span class="input-group-addon">KG</span>
       </div>
     </div>
        </div>
        ...
        <div class="input-group">
         <input type="text" class="form-control" name="product-volume" placeholder="Insert Volume" value="<?php echo remove_junk($product['volume']);?>" autocomplete="off">
       ...
       <button type="submit" name="editproductbis" class="btn btn-danger">Update</button>  
