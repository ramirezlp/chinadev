...
private $codecliTable = 'clientcode';
 ...
 public function listClientcode($prid){
	global $db;		
	$sqlQuery = "SELECT * FROM clientcode WHERE products_id = '".$prid."' AND openclose ='1'";
...
//".$_POST["clientcodeId"]."
	...
	insertstock($_POST["clientcodeClient"],$_POST["clientcodeName"],$_POST["clientcodeProductid"]);
}
